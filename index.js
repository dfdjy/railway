...
const SUB_PATH = process.env.SUB_PATH || 'licacv188';       // 订阅路径
const PORT = process.env.SERVER_PORT || process.env.PORT || 3000;        // http服务订阅端口
const UUID = process.env.UUID || '5a576813-f267-4dff-85ad-beb73717e446'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const KOMARI_ENDPOINT = process.env.KOMARI_ENDPOINT || 'https://komari.lioil.art';  // Komari 监控端点地址
const KOMARI_TOKEN = process.env.KOMARI_TOKEN || 'ebnhRZVCrHqVQs6JL0yS8y';        // Komari 认证 Token
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'railway.aovcc.cyo';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZDRhZWU4NjcwMzE1ZmE1NTU3ZjkxMzlmNTBmNmRlZDciLCJ0IjoiNDU5NzUyMTktYjkzYy00MTNhLTk1OTgtNjM2NmIyYTNjYTEyIiwicyI6Ik9ETmlZbVl3TVRNdE5tRm1NaTAwTmpRd0xUazROMlV0TlRaa05tRTRaV1psWVRVeCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const CFIP = process.env.CFIP || 'sg.ipv4.l.cd';            // 节点优选域名或优选ip
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'licacv';                        // 节点名称
